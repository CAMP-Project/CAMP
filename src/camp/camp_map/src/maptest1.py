...
class Camp_Map:
    ...
    def __init__(self): 
        ...
        rospy.init_node('map_test_1', anonymous = False)   
        ...
        self.map_publisher = rospy.Publisher('map_1', OccupancyGrid, queue_size = 10)
        ...
        self.map.info.width = 180
        self.map.info.height = 180
